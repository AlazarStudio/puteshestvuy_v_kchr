...
# SMTP для формы обратной связи в футере (отправка писем на почту)
...
**Почта для обратной связи:** в админке (Футер → Правая колонка) укажите «Почта для получения сообщений» — на неё будут приходить письма из формы.
