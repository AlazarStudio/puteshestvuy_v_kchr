...
// посетикчр.рф — основной домен (решение заказчика 03.09.2026),
// синхронно с SITE_URL в src/lib/seo/config.js
const SITE_URL = (process.env.VITE_SITE_URL || 'https://xn--e1aggnekdj1c.xn--p1ai').replace(/\/+$/, '')
