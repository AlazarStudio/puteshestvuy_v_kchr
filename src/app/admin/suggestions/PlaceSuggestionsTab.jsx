              ...
              <>
                ...
                {selected.howToGet && (
                  <div className={suggestionStyles.detailSection}>
                    ...
                    <RichTextContent className={suggestionStyles.detailText} html={selected.howToGet} />
                  </div>
                )}
                ...
                {selected.importantInfo && (
                  <div className={suggestionStyles.detailSection}>
                    ...
                    <RichTextContent className={suggestionStyles.detailText} html={selected.importantInfo} />
                  </div>
                )}
