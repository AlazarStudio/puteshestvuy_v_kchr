...
import { Plus, Search, Pencil, Trash2, Newspaper, Eye, EyeOff, ChevronLeft, ChevronRight, ExternalLink, ArrowUpDown, ArrowUp, ArrowDown, RotateCcw } from 'lucide-react';
...
export default function NewsPage() {
  ...
  const fetchNews = async (page, updateUrl = true) => {
  ...
  const handleLimitChange = (newLimit) => {
    setLimit(newLimit);
    localStorage.setItem('admin_news_limit', newLimit.toString());
      ...
      <div className={styles.pageHeader}>
        ...
        <div className={styles.pageHeaderActions}>
          <div className={styles.searchWrap}>
            <input type="text" placeholder="Поиск новостей и статей..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className={styles.searchInput} aria-label="Поиск новостей и статей" />
            <Search size={18} className={styles.searchIcon} aria-hidden />
          </div>
          <Link to="/admin/news/new" className={styles.addBtn}><Plus size={18} /> Добавить новость или статью</Link>
        </div>
      </div>
                      ...
                      <div className={styles.actions}>
                        ...
                        <Link 
                          ...
                          onClick={() => {
                            ...
                            localStorage.setItem('admin_news_return_page', currentPage.toString());
                          }}
