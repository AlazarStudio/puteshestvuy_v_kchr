...
export default function PlacesPage() {
  ...
  const [limit, setLimit] = useState(() => {
    const saved = localStorage.getItem('admin_places_limit');
  ...
  const fetchPlaces = async (page, updateUrl = true) => {
  ...
  const handleLimitChange = (newLimit) => {
    setLimit(newLimit);
    localStorage.setItem('admin_places_limit', newLimit.toString());
          ...
          <table className={styles.table}>
            <thead>
              <tr>
                ...
                <th 
                  className={`${styles.locationCell} ${styles.sortableHeader}`}
                    ...
                    <div className={styles.cellInner}>
                      ...
                      <Link 
                        ...
                        onClick={() => {
                          ...
                          localStorage.setItem('admin_places_return_page', currentPage.toString());
                        }}
